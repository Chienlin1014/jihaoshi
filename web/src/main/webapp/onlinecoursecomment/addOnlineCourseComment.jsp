...
<html>
<head>
<link rel="stylesheet" href="${ctxPath}/css/star.css">
...
<body>
	...
	<script type="text/javascript">
		document.querySelector('#courseName').textContent = '線上課程名稱 : ${param.courseName}';
		const courseNo = ${param.courseNo};
		const commentContent = document.querySelector('#commentContent');
	
		function getScore() {
			for (let i = 5; i >= 1; i--) {
				if (document.querySelector(`#rating-\${i}`).checked === true) {
					return i;
				}
			}
			return 0;
