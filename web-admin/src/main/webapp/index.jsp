			...
			<div class="layout-center" style="text-align: center">
				...
				<dl class="block_W">
					<dd id="CategoryContainer">
						<ul class="treeview">
						<li>管理員:<font color=red> ${ManagerAcc} </font><br>
									<font>權限編號: ${AuthorityNo} </font>
									</li>
						<li id="logout"><a
								href="<%=request.getContextPath()%>/manager/ManagerServlet?action=Logout">登出</a></li>
									<li><a
										href="<%=request.getContextPath()%>/manager/login.jsp">登入</a></li>
							<li id="cate_D" class="expanded"><H1>功能列表</H1>
								<ul class="main">
									<li class="drop"><a href="#">會員管理</a>
										<ul class="submenu">
											<li class="submenu-item"><a
										href="<%=request.getContextPath()%>/member/listAllMember.jsp">所有會員</a></li>
