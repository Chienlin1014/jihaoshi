...
<table id="table-1">
   <tr><td><h3>Online Course : Home</h3><h4>( MVC )</h4></td></tr>
</table>
...
<ul>
  <li><a href="${pageContext.request.contextPath}/onlinecourse/listAllOnlineCourse.jsp">List</a> all Online Courses.  <br><br></li>
  
  
  <li>
    <FORM METHOD="post" ACTION="/jihaoshitest/OnlineCourse" >
        <b>輸入線上課程編號 (如1):</b>
  ...
  <jsp:useBean id="onlinecourseSvc" scope="page" class="com.online_course.model.OnlineCourseService" />
